...
test <- GET("http://api.adzuna.com/v1/api/jobs/gb/search/1?app_id=xxx&app_key=xxx&results_per_page=20&what=javascript%20developer&content-type=application/json")
